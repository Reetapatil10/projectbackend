...
mongoose.connect('mongodb+srv://20reetapatil:FVcrdSllqKTXWngo@cluster0.jf2ikmd.mongodb.net/?retryWrites=true&w=majority')
...
app.patch("/product/edit/:id", async (req, res) => {
 ...
 app.post('/cart/add', async(req,res)=>{
  ...
  //task-10 create route to delete prodouct in cart
  app.post('/cart/product/delete',async(req,res)=>{
    try{
